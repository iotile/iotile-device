...
var TemperaturePOD = /** @class */ (function (_super) {
    __extends(TemperaturePOD, _super);
    function TemperaturePOD(iotileID, args) {
        var _this = this;
        ...
        controller.addRealtimeStreamer(iotile_common_1.mapStreamName('unbuffered node 25'), 1000);
        controller.pushReading(50, iotile_common_1.mapStreamName('unbuffered node 25'));
        return _this;
    }
    return TemperaturePOD;
}(mock_ble_device_1.MockBLEDevice));
exports.TemperaturePOD = TemperaturePOD;
